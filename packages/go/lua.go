...
// Lua scripts — identical logic to TypeScript/Python/Java/Go engine versions.
// All four SDKs share the same Redis key schema so they interoperate in the
// same Redis instance without conflict.
